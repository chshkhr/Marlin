...
#define STRING_CONFIG_H_AUTHOR "(Vlad Chursin, SapphirePro config)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    //SapphirePro 245
    #define  DEFAULT_Kp 10.54
    #define  DEFAULT_Ki 0.70
    #define  DEFAULT_Kd 39.95
    //FIND YOUR OWN: "M303 C8 S245" 8 cycles.
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //SapphirePro
  #define  DEFAULT_bedKp 198.74
  #define  DEFAULT_bedKi 30.07
  #define  DEFAULT_bedKd 328.41
  //FIND YOUR OWN: "M303 E-1 C8 S95" to run autotune on the bed at 95 degreesC for 8 cycles.
#endif // PIDTEMPBED
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 18, -37, -0.7 }
